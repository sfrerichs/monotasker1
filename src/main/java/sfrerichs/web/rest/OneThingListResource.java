...
public class OneThingListResource {
    ...
    public ResponseEntity<List<OneThingList>> getAllOneThingLists(Pageable pageable) {
        log.debug("REST request to get a page of OneThingLists");
        Page<OneThingList> page = oneThingListRepository.findAll(pageable);
