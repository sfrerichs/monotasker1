...
export const OneThingListUpdate = (props: IOneThingListUpdateProps) => {
  ...
  const { oneThingListEntity, loading, updating } = props;
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : oneThingListEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="one-thing-list-description">
                  Description
                </Label>
                <AvField id="one-thing-list-description" type="text" name="description" />
              </AvGroup>
